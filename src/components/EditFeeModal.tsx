...
export default function EditFeeModal({ fee, onClose, refreshFees }: Props) {
  const [studentId, setStudentId] = useState(String(fee.student_id));
  ...
  const handleUpdate = async () => {
    await updateFee(fee.id, Number(studentId), Number(amount), dueDate, status);
